    ...
    <div class="mb-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach($tours as $tour)
                <div class="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-all duration-300 border border-gray-100 hover:border-blue-100 group">
                    <!-- Изображение тура -->
                    ...
                    <div class="p-5">
                        ...
                        <a href="{{ route('tours.show', [$business, $tour]) }}" 
                           class="w-full inline-flex items-center justify-center px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors group-hover:shadow-sm">
                            Подробнее
